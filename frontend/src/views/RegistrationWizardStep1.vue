  ...
  <div class="min-h-screen bg-gray-50 flex items-center justify-center p-4">
    <div class="w-full max-w-md">
      ...
      <div class="bg-white border border-gray-300 rounded-lg p-8 shadow-sm">
        <h1 class="text-xl font-semibold text-gray-900 mb-2">Complete your profile</h1>
        <p class="text-sm text-gray-500 mb-6">Tell us a bit more about yourself to get started.</p>
