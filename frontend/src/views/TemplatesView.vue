...
watch(
    ...
    async (newId) => {
        if (newId) {
            try {
                templates.value = await api.organisations.templates.all(
                    orgStore.currentOrgId!
                );
            } catch (error) {
            } finally {
    ...
    <div class="p-4 lg:p-8">
        ...
        <div v-else class="hidden lg:grid grid-cols-2 xl:grid-cols-3 gap-4">
            <div
                ...
                :key="template.id"
                class="bg-white border border-gray-300 rounded-lg overflow-hidden hover:shadow-md transition-shadow"
            >
                <div class="h-40 bg-gray-100 border-b border-gray-300 p-4">
                    <div
                        class="w-full h-full border-2 border-dashed border-gray-400 rounded flex items-center justify-center"
                    >
                ...
                <div class="p-4">
                    <div class="flex items-start justify-between mb-4">
                        ...
                        <button class="p-1 hover:bg-gray-100 rounded" hidden>
        ...
        >
            ...
            >
                <div class="flex">
                    <div
                        class="w-24 h-24 bg-gray-100 border-r border-gray-300 flex items-center justify-center shrink-0"
                    >
